...
- **Faker (any):** call any method in the Faker library by path — `finance.iban`, `vehicle.vin`, `internet.userName`, `commerce.productName`, `git.commitSha`, etc. See [fakerjs.dev/api](https://fakerjs.dev/api/) for the full catalog.
